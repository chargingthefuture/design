...
import {
  ...
  Activity, Award, Target, ShieldCheck, UsersRound, AlertTriangle, ListChecks,
  Download,
} from "lucide-react";
...
const FEATURES: {
  ...
  { id: "hub",           name: "Hub",             emoji: "🏠", icon: Users,      color: "#7C3AED", bg: "#0E061A", desc: "The main community: AI-powered chat, safe channels, 5M members. Your base camp.", youtubeId: "Z9Gw3Jz0ids" },
  { id: "chyme",         name: "Chyme",            emoji: "🎙️", icon: Radio,      color: "#22C55E", bg: "#04160A", desc: "Live social audio rooms. Record, broadcast, listen, and connect in real time.", youtubeId: "oVESU60zbPg" },
  { id: "lighthouse",    name: "LightHouse",       emoji: "🏠", icon: HomeIcon,   color: "#60A5FA", bg: "#0B121C", desc: "Safe and verified housing listings. Community trust scores so you know your neighbors.", youtubeId: "KfyZsemVU8A" },
  ...
  { id: "directory",     name: "Directory",        emoji: "📇", icon: BookOpen,   color: "#93C5FD", bg: "#10161C", desc: "Skills directory and professional listings. Find a survivor-run service for almost anything.", youtubeId: "W1cZm9F0D78" },
  { id: "foundation",    name: "Foundation",       emoji: "🪛", icon: Hammer,     color: "#F59E0B", bg: "#1B1101", desc: "Tools, repairs, and infrastructure support. Logs changes in your area so nothing happens in the dark.", youtubeId: "n4Tkw01PmX8" },
  { id: "peerprog",      name: "PeerProgramming",  emoji: "🏘️", icon: Code,       color: "#6EE7B7", bg: "#0C1914", desc: "Tech mentorship and coding support. Weekly global masterminds — survivors teaching survivors.", youtubeId: "ReJ-HjM4dvo" },
  { id: "gdp",           name: "GDP",              emoji: "🗺️", icon: Globe,      color: "#06B6D4", bg: "#011417", desc: "Real-time $300B global survivor economic tracker. Your contributions counted, recorded, visible." },
  { id: "credits",       name: "ServiceCredits",   emoji: "⚙️", icon: Coins,      color: "#A855F7", bg: "#12091B", desc: "Alternative economy and credits exchange. Trade value inside the network — no outside systems needed." },
  { id: "workforce",     name: "Workforce",        emoji: "💼", icon: Briefcase,  color: "#F97316", bg: "#1B0D02", desc: "Trafficking-informed job matching. Employers vetted for survivor-safe workplaces.", protonLink: "https://drive.proton.me/urls/2C3V6KQZDC#IPmuHxdRmzOh" },
  { id: "gentlepulse",   name: "GentlePulse",      emoji: "💚", icon: Heart,      color: "#34D399", bg: "#061711", desc: "Wellness check-ins and emotional support. Gentle, consistent, non-intrusive." },
  { id: "mood",          name: "Mood",             emoji: "😁", icon: Smile,      color: "#4ADE80", bg: "#08180E", desc: "Anonymous mood tracking and pattern awareness. Know yourself. See patterns. Take back control." },
  { id: "socketrelay",   name: "SocketRelay",      emoji: "🔂", icon: Share2,     color: "#FB923C", bg: "#1C1007", desc: "Mutual aid network for urgent needs. Real-time resource sharing when it matters most.", youtubeId: "WTXpioRV2Bw" },
  { id: "what-works",    name: "What Works",       emoji: "✅", icon: ListChecks, color: "#84CC16", bg: "#0F1602", desc: "One shared, survivor-verified list of tools — organized by the exact problems survivors face. No ads, no affiliates." },
  { id: "skillshunt",    name: "SkillsHunt",       emoji: "🎓", icon: Award,      color: "#FBBF24", bg: "#1C1504", desc: "Skill discovery, credentialing, and education. Learn, prove it, get paid for it.", youtubeId: "OfojmleoDEc" },
  { id: "levelup",       name: "LevelUp",          emoji: "🎯", icon: Target,     color: "#10B981", bg: "#02140E", desc: "Goal tracking and progress milestones. Your journey, documented and celebrated." },
  { id: "trust",         name: "Trust",            emoji: "🛡️", icon: ShieldCheck,    color: "#0EA5E9", bg: "#02121A", desc: "Community reputation and verification. Trust signals built through real participation — your credibility, visible and portable." },
  { id: "clicklog",      name: "ClickLog",         emoji: "🚨", icon: AlertTriangle,  color: "#EC4899", bg: "#1A0811", desc: "One-tap personal incident logger. Privately track, timestamp, and encrypt safety incidents — your record, invisible to everyone else." },
];

const LOOK_MA_ITEMS: { q: string; solutions: string[] }[] = [
  { q: "Do idiots constantly try to get close to you physically, while aiming their cell phones at you and/or staring at their cell phones while invading your personal space?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do your co-workers that you have always been friendly with, suddenly start acting strange towards you and distancing themselves from you? Or they begin to lie about your work performance, try to get you to quit or begin bumping shoulders with you?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do idiots sit parked in their cars outside your home all the time?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do morons constantly get in your way and block you from where you are going out in public? / cut you in line? / hold up the line?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Did all your neighbors suddenly move, have their houses quickly sold and construction work done on them, then quickly have 'new neighbors' (who don't seem to live there) move in?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Have any new street lamps/antennas been installed around your home/work recently?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do drones hover around you/your home/work all the time?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you experience tinnitus/ringing in ears?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do police officers follow/harass you for no good reason?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do your neighbors always seem to come outside when you are there, then go inside when you do?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do different people seem to be coming and going from neighbors houses around you all the time?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do several of your neighbors have strange colored lights coming out their windows at night?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people you don't know stare at you strangely/treat you bad for no reason?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Are new people pushing hard for you to be their new friend/roommate/romantic partner?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people seem to know things about you that you have never told them before?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people you don't know constantly try to talk to you/befriend you while you are out in public?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  ...
  { q: "Do you get denied jobs/housing for no good reason?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you live close to a freemason lodge? Or know someone who is a freemason?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Does trying to do simple things like fill out an online job application become an ordeal due to endless clicking that brings you nowhere? Or website conveniently won't load when you try to submit applications or important documents?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do doctors deny you proper care? / ghost you? / tell you you are fine when you know something is wrong? / not get back to you with test results, then claim to have never received them, or have 'no record' of them?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you hear strange humming/buzzing noises/sound of a machine running around you a lot, but can't pinpoint exactly where it's coming from?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Does your mail get lost/tampered with a lot?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you get tired more than you should?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people try to bait you into doing drugs? Buying a gun? Buying self-defense gear? Drinking? Committing illegal acts?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "If you are a woman, do perverted guys you don't know or just met straight up ask you for sex?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "If you are sitting in your car minding your own business do idiots come and park right by/next to you and sit there too? Usually buried in their phone? Even if you are parked in an isolated area?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do idiots constantly shine their bright headlights/flashlights/DEWs on you?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you often pull up to an empty store, and then it suddenly becomes busy after you go in? Even at non busy business hours?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do weirdos try to get you to say bad things about other people? Or force a conversation about sex, politics or celebrities as if they are recording you?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Have you been falsely accused of shoplifting, then still treated like a criminal after you have proven you did not steal anything?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you notice strange flashes of light wherever you go? Or at home/work?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Does everyone around you seem to be keeping some sort of a secret?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do weirdos offer you rides/solicit you for prostitution when you are just trying to walk down the street? Even during the day?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you get strange phone calls/texts from numbers you don't know a lot?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do your pets seem to sense that something is off/someone you don't know is near?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people seem like they are only pretending to be your friend/partner?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do store/hotel clerks suddenly act strangely when you give your name/id?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "If you go to Walmart/Target do the theft detectors beep once quickly when you walk in?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people like to waste your time, sending you on wild goose chases to accomplish simple tasks/appointments?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Anytime you have to call a customer service you are put on hold forever only to be hung up on and start the cycle again and again?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you have an unusually large amount of car problems?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do items disappear, then reappear weeks/months later?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do people you've never introduced yourself to somehow already know your name?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you experience unexplained bruising/cuts/pain/injuries?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do you notice Jehovah Witnesses following you and/or lurking in your neighborhood that were not there previously?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do motorcycles, fire trucks and police cars with sirens circle around you?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do idiots mirror your behavior and how you dress and follow you around in public?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do idiot acquaintances/family you have not seen in decades, or family members you never met, try to force their way into your life?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
  { q: "Do weirdos issue attack or guard commands to have dogs bark or whimper at your presence?", solutions: ["Hub", "Chyme", "LightHouse", "TrustTransport", "Directory", "Foundation", "PeerProgramming", "GDP", "ServiceCredits", "Workforce", "GentlePulse", "Mood", "SocketRelay", "WhatWorks", "SkillsHunt", "LevelUp", "Trust", "ClickLog"] },
];
        ...
        >
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              We don't need another forum. We need infrastructure. Every feature is a shield against isolation, financial drain, and surveillance. We built all 18. Watch them in action.
            </p>
          </div>
          <Link
            href="/demos"
