...
const FEATURES: {
  ...
  { id: "what-works",    name: "What Works",       emoji: "✅", icon: ListChecks, color: "#84CC16", bg: "#0f1f00", desc: "One shared, survivor-verified list of tools — organized by the exact problems survivors face. No ads, no affiliates." },
