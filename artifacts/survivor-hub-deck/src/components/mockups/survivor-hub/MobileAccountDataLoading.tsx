// design-sync
export function MobileAccountDataLoading() {
  return (
    <div style={{ display: "flex", height: "100vh", background: "var(--comic-bg, #0F1117)", alignItems: "center", justifyContent: "center", fontFamily: "'Inter',system-ui" }}>
