...
import {
  BookOpen, Search, CheckCircle, MapPin, MessageSquare,
...
const PROFILES = [
  { id: 1, firstName: "Maria",   lastName: "Gonzalez",  role: "Trauma Therapist",    location: "Houston, TX",  online: true,  avatar: "MG", verified: true,  credits: true,  handle: "@maria-g",          source: "self"               },
  { id: 2, firstName: "James",   lastName: "Thibodeau", role: "Housing Navigator",   location: "Atlanta, GA",  online: true,  avatar: "JT", verified: true,  credits: true,  handle: "@james-t",          source: "self"               },
  { id: 3, firstName: "Amara",   lastName: "Okonkwo",   role: "Employment Coach",    location: "Chicago, IL",  online: false, avatar: "AO", verified: true,  credits: false, handle: "@community-7f3a2b", source: "community-generated" },
  { id: 4, firstName: "Priya",   lastName: "Sharma",    role: "Legal Advocate",      location: "New York, NY", online: true,  avatar: "PS", verified: true,  credits: true,  handle: "@priya-s",          source: "self"               },
  { id: 5, firstName: "Lena",    lastName: "Hoffmann",  role: "Tech Skills Trainer", location: "Remote",       online: true,  avatar: "LH", verified: true,  credits: false, handle: "@community-b2e9f1", source: "community-generated" },
];
      ...
      <div style={{ width: 390, height: "100%", minHeight: "100vh", background: "var(--comic-bg, #0F1117)", fontFamily: "'Inter', system-ui, sans-serif", color: "var(--comic-text-primary, #E8EAF0)", display: "flex", flexDirection: "column" }}>
        ...
        <ScrollArea style={{ flex: 1 }}>
          <div style={{ padding: "24px 20px" }}>
            ...
            {p.source === "community-generated" && (
              <div style={{ marginBottom: 20, padding: "14px 16px", borderRadius: 13, background: "rgba(99,102,241,0.05)", border: "1px solid rgba(99,102,241,0.22)" }}>
                ...
                {attached ? (
                  <div style={{ fontSize: 13, color: "#22C55E", display: "flex", alignItems: "center", gap: 7 }}>
                    <CheckCircle size={14} /> Profile attached — now claimed.
                  </div>
                ) : (
                  <>
                    <div style={{ display: "flex", gap: 7, marginBottom: 10 }}>
                      ...
                      <button
                        ...
                        style={{ padding: "9px 14px", borderRadius: 8, background: "#6366F1", border: "none", color: "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer", opacity: attachId.trim() ? 1 : 0.5 }}
                      >
                        Attach
                      </button>
                    </div>
                    <button
                      ...
                      style={{ fontSize: 12, color: "#6366F1", background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex", alignItems: "center", gap: 4 }}
                    >
                      Use my account →
