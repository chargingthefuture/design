...
export function GDPPublicAlt() {
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: bg, fontFamily: "'Inter', system-ui, sans-serif", color: text, overflow: "hidden" }}>
      ...
      {/* Alt banner — dark, minimal, not gradient */}
      <div style={{
        background: "#0A0D14",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 500, color: "#9CA3AF" }}>
            Survivor Hub GDP Tracker ·{" "}
            <span style={{ color: "#D1D5DB" }}>Real-time economic output of 4.9M survivors</span>
          </span>
          <span style={{
            fontSize: 11,
            fontWeight: 600,
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <button style={{
            ...
            <LogIn size={13} color="var(--comic-text-secondary, #6B7280)" /> Sign In
          </button>
          <button style={{
            padding: "5px 14px",
            borderRadius: 7,
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <main style={{ flex: 1, overflowY: "auto", padding: "24px 32px" }}>
          ...
          <div style={{ borderRadius: 16, border: `1px solid ${border}`, background: surface, padding: "20px 24px", marginBottom: 20 }}>
            ...
            {TOP_COUNTRIES.map(({ flag, country, gdp, members }) => (
