      ...
      <div style={{ flex: 1, padding: "0 20px 20px", position: "relative" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 10, filter: "blur(4px)", pointerEvents: "none", opacity: 0.4 }}>
          ...
          {["First Name", "Bio", "Quora Profile URL", "Skills", "Claimed Professions"].map(f => (
            <div key={f}>
              <div style={{ fontSize: 11, color: "var(--comic-text-secondary, #6B7280)", marginBottom: 4 }}>{f}</div>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--comic-text-secondary, #6B7280)", textAlign: "center", maxWidth: 260, lineHeight: 1.5 }}>Survivors only. Nominate people you believe may be survivors and help build our self-sustaining economy.</div>
